...
document.getElementById('daily-form').addEventListener('submit' , async(e)=>{
    ...
    try{
        ...
        const res = await axios.post('http://localhost:6300/getdate' , {date} ,{
            headers: {
...
document.getElementById('yearly-form').addEventListener('submit' , async(e)=>{
    ...
    try{
        const token=localStorage.getItem('token')
        const res = await axios.post('http://localhost:6300/getYearly' , {year},{
            headers: {
                'Content-Type': 'application/json',
                "Authorization": `Bearer ${token}`,
            }
...
document.getElementById('monthly-form').addEventListener('submit' , async(e)=>{
    ...
    try{
        ...
        const res = await axios.post('http://localhost:6300/getMonthly' , {month},{
            headers: {
                'Content-Type': 'application/json',
                "Authorization": `Bearer ${token}`,
            }
...
async function displayWeekly(){
    ...
    try{
        const token=localStorage.getItem('token')
        const res = await axios.get('http://localhost:6300/getweekly',{
            headers: {
                'Content-Type': 'application/json',
                "Authorization": `Bearer ${token}`,
            }
